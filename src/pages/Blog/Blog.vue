<template>
  <b-container fluid>
        ...
        <div class="row justify-content-center">
          <div class="col-6">
            <button
              ...
              @click="$router.push({ path: 'blog/add' })"
            >
              <i class="nc-icon nc-simple-add"> New post</i>
            </button>
          </div>
        </div>
      </b-col>
      ...
      <b-col lg="6" class="my-1">
        ...
        >
          <b-form-checkbox-group v-model="filterOn" class="mt-1">
            <b-form-checkbox value="name">Blog Name</b-form-checkbox>
          ...
          >
            ...
            <template #cell(actions)="row">
              ...
              <button
                ...
                @click="info(row.item, row.index, $Blog.target)"
              >
    ...
    >
      <pre>
are you sure want to delete <strong>{{ infoModal.title }} </strong>from Blog list ?</pre>
    </b-modal>
  </b-container>
</template>
        ...
        },
        {
          ...
          formatter: (value, key, item) => {
            return (
              ...
              " " +
              this.month_name[new Date(item.created_at).getMonth()] +
              " " +
              new Date(item.created_at).getFullYear().toString().substr(-2)
            );
          },
          sortDirection: "desc",
