              ...
              <b-form @submit="onSubmit">
                ...
                >
                  <b-form-input
                    ...
                    type="text"
                    required
                    placeholder="Category name ex: BANSOS KEMENAG 2021"
                  ></b-form-input>
                </b-form-group>
...
export default {
  ...
  methods: {
    ...
    async onSubmit(evt) {
      ...
      let data = this.form;
      try {
        let res = await Category.UpdateTag(this.$route.params.id, data);
        if (res.data.success) {
          this.success = true;
          this.$notify({
            message: "success",
  ...
  async created() {
    try {
      ...
      let getdetail = await Category.DetailTag(this.$route.params.id);
