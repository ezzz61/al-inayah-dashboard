<template>
  <b-container fluid>
        ...
        <div class="row justify-content-center">
          <div class="col-6">
            <button
              ...
              @click="$router.push({ path: 'Faq/add' })"
            >
              <i class="nc-icon nc-simple-add"> New Faq</i>
            </button>
          </div>
        </div>
      </b-col>
    ...
    >
      <pre>
are you sure want to delete <strong>{{ infoModal.title }} </strong>from Faq list ?</pre>
    </b-modal>
  </b-container>
</template>
