<template>
  <b-container fluid>
        ...
        <div class="row justify-content-center">
          <div class="col-6">
            <button
              ...
              @click="$router.push({ path: 'Babes/add' })"
            >
              <i class="nc-icon nc-simple-add"> New Babes</i>
            </button>
          </div>
        </div>
      </b-col>
      ...
      <b-col lg="6" class="my-1">
        ...
        >
          <b-form-checkbox-group v-model="filterOn" class="mt-1">
            <b-form-checkbox value="title">Babes Name</b-form-checkbox>
      ...
      <div class="col-12">
        ...
        >
          ...
          <b-table
            ...
            @filtered="onFiltered"
          >
            <!-- <template v-slot:cell(Babes)="row">
              {{ row.item.Babes_id[0].name }}
            </template> -->
    ...
    >
      <pre>
are you sure want to delete <strong>{{ infoModal.title }} </strong>from Babes list ?</pre>
    </b-modal>
  </b-container>
</template>
