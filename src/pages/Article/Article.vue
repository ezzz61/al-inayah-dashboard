        ...
        <div class="row justify-content-center">
          <div class="col-6">
            <button
              ...
              @click="$router.push({ path: 'Article/add' })"
            >
              <i class="nc-icon nc-simple-add"> New Article</i>
            </button>
          </div>
        </div>
      </b-col>
      ...
      <b-col lg="6" class="my-1">
        ...
        >
          <b-form-checkbox-group v-model="filterOn" class="mt-1">
            <b-form-checkbox value="title">Article Name</b-form-checkbox>
      ...
      <div class="col-12">
        ...
        >
          ...
          <b-table
            ...
            @filtered="onFiltered"
          >
            <!-- <template v-slot:cell(Article)="row">
              {{ row.item.Article_id[0].name }}
            </template> -->
...
export default {
  ...
  methods: {
    ...
    async handleOk(id) {
      ...
      try {
        let res = await Article.Delete(id);
        if (res.data.success) {
          this.success = true;
          this.notifyVue();
          this.loArticletart();
