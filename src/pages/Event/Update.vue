        ...
        <div class="col-4">
          <card class="card-user">
            ...
            >
              <p>
                {{
                  this.day_week[new Date(form.start_date).getDay()] +
                  ", " +
                  new Date(form.start_date).getDate().toString() +
                  " " +
                  this.month_name[new Date(form.start_date).getMonth()] +
                  " " +
                  new Date(form.start_date)
                    ...
                    .substr(-2) +
                  " - " +
                  this.day_week[new Date(form.end_date).getDay()] +
                  ", " +
                  new Date(form.end_date).getDate().toString() +
                  " " +
                  this.month_name[new Date(form.end_date).getMonth()] +
                  " " +
                  new Date(form.end_date).getFullYear().toString().substr(-2)
                }}
              </p>
            </div>
          </card>
      ...
      if (this.allImage.length === 0) {
        ...
        try {
          ...
          if (res.data.success) {
            ...
            let res_upload = await Event.Upload(this.$route.params.id, setdata);
