      ...
      <b-col lg="6" class="my-1">
        <div class="row justify-content-center">
          <div class="col-6">
            ...
            >
              <i class="nc-icon nc-simple-add"> New Event & Promotion</i>
            </button>
          </div>
        </div>
      </b-col>
        ...
        },
        {
          ...
          formatter: (value, key, item) => {
            return (
              ...
              " " +
              this.month_name[new Date(item.start_date).getMonth()] +
              " " +
              new Date(item.start_date).getFullYear().toString().substr(-2)
            );
          },
          sortDirection: "desc",
